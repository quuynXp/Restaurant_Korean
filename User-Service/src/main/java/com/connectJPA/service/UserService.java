...
import com.connectJPA.constant.PredefinedRole;
...
import com.connectJPA.mapper.UserMapper;
import com.connectJPA.repository.RoleRepository;
...
public class UserService {
    ...
    public UserResponse createUser(UserCreationRequest request) {
        ...
        UserDocument doc = new UserDocument(user.getId(), user.getUsername(), user.getEmail(), user.getRoles());
